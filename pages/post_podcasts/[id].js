...
export async function getServerSideProps({ params, req }) {
    let single = await checkLanguage('/podcasts?slug=' + params.id, req);
    let multiple = await checkLanguage('/podcasts?slug_ne=' + params.id + '&_limit=6&_sort=createdAt:DESC', req);
